...
def initialize_establishments(parameters):
    ...
    Data:
        number_of_establishments per municipality (source: https://onedrive.live.com/view.aspx?resid=9CD3CF10466EFD3A!1640&ithint=file%2cxlsx&authkey=!AHhicsAgoFjxveA)    
    """
...
def create_employee_sizes(parameters):
    ...
    Data:
        number_of_establishments - employee sizes (source: https://onedrive.live.com/view.aspx?resid=9CD3CF10466EFD3A!1640&ithint=file%2cxlsx&authkey=!AHhicsAgoFjxveA)
    """
