...
class Main():
    ...
    def initialize_pop(self, loc_data = None):
        ...
        pop_households_assignment   = hh.assign_household_members(self.params, loc_data['households'], pop_to_assign)                                           #assign population to a household
        
        students, pop_to_assign = pop.get_students(self.params, pop_to_assign['uid'], pop_to_assign['ages'])                                                    #assign portion of population as students
        employed_left, unemployed                   = pop.get_employed(self.params, pop_to_assign['uid'], pop_to_assign['ages'])                                #assign portion of population as employed
        teachers     , employed_left                = pop.get_teachers(self.params, employed_left['uid'], employed_left['ages'])                                #assign a portion of employed as teachers
        staff        , employed_left                = pop.get_school_staff(self.params, employed_left['uid'], employed_left['ages'])                            #assign a portion of employed as school staff
        establishment_employees , employed_left     = pop.get_establishment_employees(loc_data['establishments'], employed_left['uid'], employed_left['ages'])  #assign a portion of employed as establishment employees
        
        # NOTE: there are still some employed left... need to resolve.
    ...
    def create_population(self, pop_init, households, schools, establishments):
        ...
        Args:
            pop_init (_type_): _description_
            households (_type_): _description_
            schools (_type_): _description_
            establishments (_type_): _description_
